...
PAT = 'EAADP97rZC7bYBAH7quLww8uDTSnJK4FeBvGnQ8WrSk9X1zcjwAkYf4R4QXGhjzgOPPGdGax4s3JuoSB3YYpBWjzIjJlXZAkvsZAHBksmzCIOcYRGzf5VSoBeqeC1t08vaYOi1OqXtPiDbZBlIofuIr0ilLLufcWi8knk9L7ILQ3dZCnIwwZCdr'

CLIENT_ACCESS_TOKEN = '5f335fe175b140b481d54dff00c9bd77'
...
def parse_user_message(user_text):
    ...
    if (responseStatus == 200):
        ...
        try:
            ...
            owm = pyowm.OWM('91bc41f9678fd28b7df555530849350c')  # You MUST provide a valid API key
            print(owm)
